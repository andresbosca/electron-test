...
export class migrations1668537654216 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "amenities" ADD CONSTRAINT "FK_34213d07cb877dbc5a3fae2c214" FOREIGN KEY ("propertyId") REFERENCES "property"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "amenities" DROP CONSTRAINT "FK_34213d07cb877dbc5a3fae2c214"`,
    );
